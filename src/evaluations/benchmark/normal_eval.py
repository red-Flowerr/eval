...
def college_math_dataset_postprocess(text: str) -> str:
    return text.replace("$", "").strip()

def college_math_predict_postprocess(text: str) -> str:
...
def minerva_math_dataset_postprocess(text: str) -> str:
    return extract_answer(text, 'minerva_math')


def cmath_math_dataset_postprocess(text: str) -> str:
    return text.strip()

def gaokao_math_cloze_dataset_postprocess(text: str) -> str:
    return text.replace("$", "").strip()
