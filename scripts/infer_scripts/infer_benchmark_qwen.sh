...
sample_num=1
# 换成自己要infer的model
save_name=open-o1-llama3.1-8B-sft-v0.2-1000-refinforce-v0.1-refinforce-v0.1_Bo64-difficulty-mixture-v2-hard-5k_32gpu_Bo32-Ep1-len-8k-final
model_name_or_path=/map-vepfs/yizhi/OpenRLHF/checkpoint/open-o1-llama3.1-8B-sft-v0.2-1000-refinforce-v0.1-refinforce-v0.1_Bo64-difficulty-mixture-v2-hard-5k_32gpu_Bo32-Ep1-len-8k

# datasets=('data_from_train_math')
# datasets=('aime' 'cmath' 'gaokao2024' 'gaokao_math_cloze' 'gaokao_math_qa' 'gaokao2023en' 'amc23' 'olympiadbench' 'college_math' 'omni_math' 'gpqa_diamond') # Add more datasets here
datasets=('gsm8k' 'math' 'mmlu' 'bbh' 'data_from_train_math')
task=zs
base_dir=$(pwd)
