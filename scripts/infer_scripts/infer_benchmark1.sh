...
save_name=llama-v0.2_reinforce-v0.1_mix-data-v4_step50
model_name_or_path=/map-vepfs/yizhi/OpenRLHF/checkpoint/open-o1-llama3.1-8B-sft-v0.2-1000-refinforce-v0.1_Bo64-difficulty-mixture-v4-hard-no-numina-10k_64gpu_Bo32-Ep1-len-16k_global_step50

# datasets=('mmlu')
# datasets=('aime')
datasets=('omni_math' 'math' 'gsm8k' 'college_math' 'data_from_train_math') # Add more datasets here
